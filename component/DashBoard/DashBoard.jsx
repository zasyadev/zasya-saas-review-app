            ...
            <div className="container mx-auto max-w-full">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="rounded-xl bg-white">
                  <div className="w-full  rounded-xl overflow-hdden px-4 py-5 bg-white ">
                    <div className="flex flex-wrap items-center border-gray-200 ">
                      <div className="grd-bg-pink  mb-4 rounded-full text-white grid items-center w-10 h-10 py-1 px-1 justify-center ">
                        <Image
                          src={ReviewIcon}
                          alt="logo"
                          width={20}
                      ...
                      <div className="w-full pl-3 max-w-full flex-grow flex-1 mb-2  ">
                        <div className="text-gray-900 font-semibold tracking-wide text-sm mb-1 ">
                          Review Answered
                        </div>
                ...
                <div className="bg-white rounded-xl ">
                  <div className="w-full bg-white rounded-xl overflow-hdden  px-4 py-5">
                    <div className="flex flex-wrap  border-gray-200 ">
                      ...
                      <div className="w-full pl-3 max-w-full flex-grow flex-1 mb-2  ">
                        <h5 className="text-gray-900 font-semibold tracking-wide text-sm mb-1 ">
                          Users
                        </h5>
                        <span className="text-2xl text-gray-900 font-semibold">
